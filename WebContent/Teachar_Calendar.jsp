...
<link rel="stylesheet" type="text/css"
	href="/LOVE_BERRY_WEB/css/Teacher_Cal.css">
		...
		<div class="add_subject">
			<form id="form_add_subject">
				<div class="modal-header" id="modal-header">
					<label>新規科目登録</label>
					<button class="modal-close-btn" id="close-btn" value="x">
						<i class="fa fa-times" title="とじろー！"></i>
					</button>
					<hr>
				</div>
				<div class="modal-body" id="modal-body">
					<div class="row">
						<!-- @TODO:コンボボックスにします！ -->
						<label>科目名</label> <select id="input_subject_cd">
						</select>
					</div>
					<div class="row">
						<label>日付：</label> <input type="text" id="input_start_date"
							placeholder="yyyy-mm-dd">
					</div>
					<div class="row">
						<label>時限：</label> <select id="input_start_time_cd">
					...
					<div class="row">
						<div class="roomName">
							<label>使用教室１：</label> <select id="input_room_cd1">
					...
					<div class="row">
						<div class="roomName">
							<label>使用教室２：</label> <select id="input_room_cd2">
					...
					<div class="row">
						<div class="roomName">
							<label>使用教室３：</label> <select id="input_room_cd3">
								<optgroup label="<---不使用--->"></optgroup>
								<option value="" selected="selected">使わない</option>
								<optgroup label="><---1階教室--->"></optgroup>
								<option value="101">101教室</option>
					...
					<div class="row">
						<label>コメント：</label> <input type="text" id="input_comment"
