		...
		<table>
			...
			<tr id="res">
				<td>
					...
					value="<%=student.getSeki_no()%> " checked> <%
 	isFirst = false;
 			} else {
 %> <input type="radio" name="seki_no"
					value="<%=student.getSeki_no()%> "> <%
 	}
 %>
				</td>
				<td id="num"><%=student.getSeki_no()%></td>
				<td class="sub"><%=student.getName()%></td>
				<td id="come"><%=student.getMessage()%></td>
			</tr>
			<%
				}
