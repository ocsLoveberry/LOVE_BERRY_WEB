	...
	<br>
		<table>
			...
			<tr>
				...
				<td><a href="ShowTeacherSubjectInformationChangeServlet?subject_cd=<%=viewJugyo.getSubjects_cd()%>&start_date= <%=viewJugyo.getStart_date()%>&start_time_cd=<%=viewJugyo.getStart_time_cd()%>">編集する</a></td>
			</tr>
			<%
				i++;
				}
